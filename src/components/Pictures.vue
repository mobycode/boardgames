      ...
      <div class="row">
        <div class="col">
          <div v-masonry transition-duration="0.3s" item-selector=".pic-parent">
            <div v-masonry-tile v-for="(item) in displayedItems" :key="item.id" class="pic-parent">
              <div class="pic">
                <div class="rank">
                ...
                <div :class="[!!item.picture ? 'pic-picture' : 'pic-thumbnail']">
                  <img :src="item | formatItemPictureSrc" />
                </div>
                <div class="name">
...
export default {
  ...
  methods: {
    ...
    updateCards() {
      // const cards = this.$el.querySelectorAll('.pic-parent img');
      // let card; let item; let i; let src; let div; let img;
