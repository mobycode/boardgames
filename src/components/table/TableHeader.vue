...
<div class="container-fluid thead" :class="{ 'sort-descending': isSortDescending }">
    <div class="row">
        ...
        <div class="th sortable d-none d-md-block col-md col-lg-1 col-xl-1" @click="sortBy('lastplayed')" v-else><span :class="{ sorted: isSorted('lastplayed') }">Played<br><a href="javascript:void(0)" @click.stop="toggleOwner()">{{ selectedOwner }}</a></span></div>
